...
export const div_items = (face_arr: any[]) => {
  // var text_arr = [
  //   `position: absolute; font-size: 10px;width: ${location.width}px;height: ${location.height}px;left: ${location.left}px;top: ${location.top}px;rotation: ${location.rotation}deg;background: transparent;border: 1px solid green;transform: rotate(${location.rotation}deg)`,
  //   `position: absolute; font-size: 10px;width: ${location.width}px;height: ${location.height}px;left: ${location.left}px;top: ${50}px;rotation: ${location.rotation}deg;background: transparent;border: 1px solid green;transform: rotate(${location.rotation}deg)`,
  //   `position: absolute; font-size: 10px;width: ${location.width}px;height: ${location.height}px;left: ${location.left}px;top: ${0}px;rotation: ${location.rotation}deg;background: transparent;border: 1px solid green;transform: rotate(${location.rotation}deg)`,
  // ]
